...
CREATE PROCEDURE dbo.usp_dyn_find_boq_item_with_projectvar_sql
@PrjId BIGINT,
@ProjectVariableTemplateId bigint,
@wbs1 bit = 0,
@wbs2 bit =0 ,
@groupCode1 bit =0 ,
@groupCode2 bit =0 ,
...
DECLARE @MainPart1 NVARCHAR(MAX)
DECLARE @MainPartIntermediate NVARCHAR(MAX)
DECLARE @MainPart2 NVARCHAR(MAX)
...
IF @ProjectVariableTemplateId is not null AND @ProjectVariableTemplateId <> -1 
SET @MainPartIntermediate=''
ELSE
SET @MainPartIntermediate=''
SET @MainPart1='
SELECT 
...
SET @MainPart2 = 'o.BOQITEMID AS boqitemId,
...
IF @wbs1=1
	...
	ELSE
		SET @Wbs1Part =''
IF @wbs2 =1
	SET @Wbs2Part ='WBSCODE2DATA.CODE1 AS boqItemWbsCode2Level1Code,
...
cross apply (select SUBSTRING(o.WBSCODE,0,CHARINDEX(' + CHAR(39) + '-' + CHAR(39) + ',o.WBSCODE))+' + CHAR(39) + '.' + CHAR(39) + ') as WBS1(CODEONLY)
  ...
  outer apply (
	select
		max(l1.CODE) as CODE1, max(l1.ITEMCODE) as ITEMCODE1, max(l1.TITLE) as TITLE1, max(l1.DESCRIPTION) as DESCRIPTION1, max(l1.UNIT) as UNIT1, max(l1.UFACT) as UFACT1,
		max(l2.CODE) as CODE2, max(l2.ITEMCODE) as ITEMCODE2, max(l2.TITLE) as TITLE1, max(l2.DESCRIPTION) as DESCRIPTION2, max(l2.UNIT) as UNIT2, max(l2.UFACT) as UFACT2,
		max(l3.CODE) as CODE3, max(l3.ITEMCODE) as ITEMCODE3, max(l3.TITLE) as TITLE1, max(l3.DESCRIPTION) as DESCRIPTION3, max(l3.UNIT) as UNIT3, max(l3.UFACT) as UFACT3,
		max(l4.CODE) as CODE4, max(l4.ITEMCODE) as ITEMCODE4, max(l4.TITLE) as TITLE1, max(l4.DESCRIPTION) as DESCRIPTION4, max(l4.UNIT) as UNIT4, max(l4.UFACT) as UFACT4,
		max(l5.CODE) as CODE5, max(l5.ITEMCODE) as ITEMCODE5, max(l5.TITLE) as TITLE1, max(l5.DESCRIPTION) as DESCRIPTION5, max(l5.UNIT) as UNIT5, max(l5.UFACT) as UFACT5,
		max(l6.CODE) as CODE6, max(l6.ITEMCODE) as ITEMCODE6, max(l6.TITLE) as TITLE1, max(l6.DESCRIPTION) as DESCRIPTION6, max(l6.UNIT) as UNIT6, max(l6.UFACT) as UFACT6,
		max(l7.CODE) as CODE7, max(l7.ITEMCODE) as ITEMCODE7, max(l7.TITLE) as TITLE1, max(l7.DESCRIPTION) as DESCRIPTION7, max(l7.UNIT) as UNIT7, max(l7.UFACT) as UFACT7,
		max(l8.CODE) as CODE8, max(l8.ITEMCODE) as ITEMCODE8, max(l8.TITLE) as TITLE1, max(l8.DESCRIPTION) as DESCRIPTION8, max(l8.UNIT) as UNIT8, max(l8.UFACT) as UFACT8,
		max(l9.CODE) as CODE9, max(l9.ITEMCODE) as ITEMCODE9, max(l9.TITLE) as TITLE1, max(l9.DESCRIPTION) as DESCRIPTION9, max(l9.UNIT) as UNIT9, max(l9.UFACT) as UFACT9
		from '+@Dbname+'.dbo.PROJECTWBS as l1 with (nolock) 
			 ...
			 left join '+@Dbname+'.dbo.PROJECTWBS l9 ON l9.CODE = WBSCODE1.LEVEL9
		where l1.CODE = WBSCODE1.LEVEL1 AND l1.PRJID = ' + cast(@PrjId as varchar(max)) + '

  ) AS WBSCODE1DATA(CODE1,ITEMCODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,ITEMCODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,ITEMCODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,ITEMCODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,ITEMCODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,ITEMCODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,ITEMCODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,ITEMCODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,ITEMCODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
' 
ELSE
SET @Wbs1PartOuterApply =''
IF @wbs2 =1
  ...
  outer apply (
	select
		...
		from '+@Dbname+'.dbo.PROJECTWBS2 as l1 with (nolock)
			 left join '+@Dbname+'.dbo.PROJECTWBS l2 ON l2.CODE = WBSCODE1.LEVEL2 AND l2.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l3 ON l3.CODE = WBSCODE1.LEVEL3 AND l3.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l4 ON l4.CODE = WBSCODE1.LEVEL4 AND l4.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l5 ON l5.CODE = WBSCODE1.LEVEL5 AND l5.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l6 ON l6.CODE = WBSCODE1.LEVEL6 AND l6.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l7 ON l7.CODE = WBSCODE1.LEVEL7 AND l7.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l8 ON l8.CODE = WBSCODE1.LEVEL8 AND l8.PRJID = ' + cast(@PrjId as varchar(max)) + '
			 left join '+@Dbname+'.dbo.PROJECTWBS l9 ON l9.CODE = WBSCODE1.LEVEL9 AND l9.PRJID = ' + cast(@PrjId as varchar(max)) + '
		where l1.CODE = WBSCODE1.LEVEL1 AND l1.PRJID = ' + cast(@PrjId as varchar(max)) + '
  ) AS WBSCODE2DATA(CODE1,ITEMCODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,ITEMCODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,ITEMCODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,ITEMCODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,ITEMCODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,ITEMCODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,ITEMCODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,ITEMCODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,ITEMCODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) '
ELSE
SET @Wbs2PartOuterApply =''
IF @groupCode1 =1	
...
cross apply (select SUBSTRING(o.GROUPCODE,0,CHARINDEX(' + CHAR(39) + '-' + CHAR(39) + ',o.GROUPCODE))+' + CHAR(39) + '.' + CHAR(39) + ') as GC1(CODEONLY)
  ...
  outer apply (
	select
		max(l1.GROUPCODE) as CODE1, max(l1.TITLE) as TITLE1, max(l1.DESCRIPTION) as DESCRIPTION1, max(l1.UNIT) as UNIT1, max(l1.UFACT) as UFACT1,
		max(l2.GROUPCODE) as CODE2, max(l2.TITLE) as TITLE1, max(l2.DESCRIPTION) as DESCRIPTION2, max(l2.UNIT) as UNIT2, max(l2.UFACT) as UFACT2,
		max(l3.GROUPCODE) as CODE3, max(l3.TITLE) as TITLE1, max(l3.DESCRIPTION) as DESCRIPTION3, max(l3.UNIT) as UNIT3, max(l3.UFACT) as UFACT3,
		max(l4.GROUPCODE) as CODE4, max(l4.TITLE) as TITLE1, max(l4.DESCRIPTION) as DESCRIPTION4, max(l4.UNIT) as UNIT4, max(l4.UFACT) as UFACT4,
		max(l5.GROUPCODE) as CODE5, max(l5.TITLE) as TITLE1, max(l5.DESCRIPTION) as DESCRIPTION5, max(l5.UNIT) as UNIT5, max(l5.UFACT) as UFACT5,
		max(l6.GROUPCODE) as CODE6, max(l6.TITLE) as TITLE1, max(l6.DESCRIPTION) as DESCRIPTION6, max(l6.UNIT) as UNIT6, max(l6.UFACT) as UFACT6,
		max(l7.GROUPCODE) as CODE7, max(l7.TITLE) as TITLE1, max(l7.DESCRIPTION) as DESCRIPTION7, max(l7.UNIT) as UNIT7, max(l7.UFACT) as UFACT7,
		max(l8.GROUPCODE) as CODE8, max(l8.TITLE) as TITLE1, max(l8.DESCRIPTION) as DESCRIPTION8, max(l8.UNIT) as UNIT8, max(l8.UFACT) as UFACT8,
		max(l9.GROUPCODE) as CODE9, max(l9.TITLE) as TITLE1, max(l9.DESCRIPTION) as DESCRIPTION9, max(l9.UNIT) as UNIT9, max(l9.UFACT) as UFACT9
		from GROUPCODE as l1 with (nolock) 
			 left join GROUPCODE l2 ON l2.GROUPCODE = GROUPCODE1.LEVEL2    
			 left join GROUPCODE l3 ON l3.GROUPCODE = GROUPCODE1.LEVEL3
			 left join GROUPCODE l4 ON l4.GROUPCODE = GROUPCODE1.LEVEL4
			 left join GROUPCODE l5 ON l5.GROUPCODE = GROUPCODE1.LEVEL5
			 left join GROUPCODE l6 ON l6.GROUPCODE = GROUPCODE1.LEVEL6
			 left join GROUPCODE l7 ON l7.GROUPCODE = GROUPCODE1.LEVEL7
			 left join GROUPCODE l8 ON l8.GROUPCODE = GROUPCODE1.LEVEL8 
			 left join GROUPCODE l9 ON l9.GROUPCODE = GROUPCODE1.LEVEL9
		where l1.GROUPCODE = GROUPCODE1.LEVEL1
  ) AS GROUPCODE1DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
' 
ELSE
SET @GRoupCode1PartCrossApply =''
IF @groupCode2 =1	
  ...
  outer apply (
	select
		...
		from GEKCODE as l1 with (nolock)
			 left join GEKCODE l2 ON l2.GROUPCODE = GROUPCODE2.LEVEL2    
			 left join GEKCODE l3 ON l3.GROUPCODE = GROUPCODE2.LEVEL3
			 left join GEKCODE l4 ON l4.GROUPCODE = GROUPCODE2.LEVEL4
			 left join GEKCODE l5 ON l5.GROUPCODE = GROUPCODE2.LEVEL5
			 left join GEKCODE l6 ON l6.GROUPCODE = GROUPCODE2.LEVEL6
			 left join GEKCODE l7 ON l7.GROUPCODE = GROUPCODE2.LEVEL7
			 left join GEKCODE l8 ON l8.GROUPCODE = GROUPCODE2.LEVEL8 
			 left join GEKCODE l9 ON l9.GROUPCODE = GROUPCODE2.LEVEL9
		where l1.GROUPCODE = GROUPCODE2.LEVEL1
  ) AS GROUPCODE2DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
'
ELSE
SET @GRoupCode2PartCrossApply =''
IF @groupCode3 =1
  ...
  outer apply (
	select
		...
		from EXTRACODE1 as l1 with (nolock)
			 left join EXTRACODE1 l2 ON l2.GROUPCODE = GROUPCODE3.LEVEL2    
			 left join EXTRACODE1 l3 ON l3.GROUPCODE = GROUPCODE3.LEVEL3
			 left join EXTRACODE1 l4 ON l4.GROUPCODE = GROUPCODE3.LEVEL4
			 left join EXTRACODE1 l5 ON l5.GROUPCODE = GROUPCODE3.LEVEL5
			 left join EXTRACODE1 l6 ON l6.GROUPCODE = GROUPCODE3.LEVEL6
			 left join EXTRACODE1 l7 ON l7.GROUPCODE = GROUPCODE3.LEVEL7
			 left join EXTRACODE1 l8 ON l8.GROUPCODE = GROUPCODE3.LEVEL8 
			 left join EXTRACODE1 l9 ON l9.GROUPCODE = GROUPCODE3.LEVEL9
		where l1.GROUPCODE = GROUPCODE3.LEVEL1
  ) AS GROUPCODE3DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
'
ELSE
SET @GRoupCode3PartCrossApply =''
IF @groupCode4 =1
  ...
  outer apply (
	select
		...
		from EXTRACODE2 as l1 with (nolock)
			 ...
			 left join EXTRACODE2 l3 ON l3.GROUPCODE = GROUPCODE4.LEVEL3
			 left join EXTRACODE2 l4 ON l4.GROUPCODE = GROUPCODE4.LEVEL4
			 left join EXTRACODE2 l5 ON l5.GROUPCODE = GROUPCODE4.LEVEL5
			 left join EXTRACODE2 l6 ON l6.GROUPCODE = GROUPCODE4.LEVEL6
			 left join EXTRACODE2 l7 ON l7.GROUPCODE = GROUPCODE4.LEVEL7
			 left join EXTRACODE2 l8 ON l8.GROUPCODE = GROUPCODE4.LEVEL8 
			 left join EXTRACODE2 l9 ON l9.GROUPCODE = GROUPCODE4.LEVEL9
		where l1.GROUPCODE = GROUPCODE4.LEVEL1
  ) AS GROUPCODE4DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) '
ELSE
SET @GRoupCode4PartCrossApply =''
IF @groupCode5 =1
  ...
  outer apply (
	select
		...
		from EXTRACODE3 as l1 with (nolock)
			 left join EXTRACODE3 l2 ON l2.GROUPCODE = GROUPCODE5.LEVEL2    
			 left join EXTRACODE3 l3 ON l3.GROUPCODE = GROUPCODE5.LEVEL3
			 left join EXTRACODE3 l4 ON l4.GROUPCODE = GROUPCODE5.LEVEL4
			 left join EXTRACODE3 l5 ON l5.GROUPCODE = GROUPCODE5.LEVEL5
			 left join EXTRACODE3 l6 ON l6.GROUPCODE = GROUPCODE5.LEVEL6
			 left join EXTRACODE3 l7 ON l7.GROUPCODE = GROUPCODE5.LEVEL7
			 left join EXTRACODE3 l8 ON l8.GROUPCODE = GROUPCODE5.LEVEL8 
			 left join EXTRACODE3 l9 ON l9.GROUPCODE = GROUPCODE5.LEVEL9
  ...
  outer apply (
	select
		...
		from EXTRACODE4 as l1 with (nolock)
			 left join EXTRACODE4 l2 ON l2.GROUPCODE = GROUPCODE6.LEVEL2    
			 left join EXTRACODE4 l3 ON l3.GROUPCODE = GROUPCODE6.LEVEL3
			 left join EXTRACODE4 l4 ON l4.GROUPCODE = GROUPCODE6.LEVEL4
			 left join EXTRACODE4 l5 ON l5.GROUPCODE = GROUPCODE6.LEVEL5
			 left join EXTRACODE4 l6 ON l6.GROUPCODE = GROUPCODE6.LEVEL6
			 left join EXTRACODE4 l7 ON l7.GROUPCODE = GROUPCODE6.LEVEL7
			 left join EXTRACODE4 l8 ON l8.GROUPCODE = GROUPCODE6.LEVEL8 
			 left join EXTRACODE4 l9 ON l9.GROUPCODE = GROUPCODE6.LEVEL9
		where l1.GROUPCODE = GROUPCODE6.LEVEL1
  ) AS GROUPCODE6DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
'
ELSE
SET @GRoupCode6PartCrossApply =''
IF @groupCode7 =1
  ...
  outer apply (
	select
		...
		from EXTRACODE5 as l1 with (nolock)
			 left join EXTRACODE5 l2 ON l2.GROUPCODE = GROUPCODE7.LEVEL2    
			 left join EXTRACODE5 l3 ON l3.GROUPCODE = GROUPCODE7.LEVEL3
			 left join EXTRACODE5 l4 ON l4.GROUPCODE = GROUPCODE7.LEVEL4
			 left join EXTRACODE5 l5 ON l5.GROUPCODE = GROUPCODE7.LEVEL5
			 left join EXTRACODE5 l6 ON l6.GROUPCODE = GROUPCODE7.LEVEL6
			 left join EXTRACODE5 l7 ON l7.GROUPCODE = GROUPCODE7.LEVEL7
			 left join EXTRACODE5 l8 ON l8.GROUPCODE = GROUPCODE7.LEVEL8 
			 left join EXTRACODE5 l9 ON l9.GROUPCODE = GROUPCODE7.LEVEL9
		where l1.GROUPCODE = GROUPCODE7.LEVEL1
  ) AS GROUPCODE7DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
'	
ELSE
SET @GRoupCode7PartCrossApply =''
IF @groupCode8 =1
  ...
  outer apply (
	select
		...
		from EXTRACODE6 as l1 with (nolock)
			 left join EXTRACODE6 l2 ON l2.GROUPCODE = GROUPCODE8.LEVEL2    
			 left join EXTRACODE6 l3 ON l3.GROUPCODE = GROUPCODE8.LEVEL3
			 left join EXTRACODE6 l4 ON l4.GROUPCODE = GROUPCODE8.LEVEL4
			 left join EXTRACODE6 l5 ON l5.GROUPCODE = GROUPCODE8.LEVEL5
			 left join EXTRACODE6 l6 ON l6.GROUPCODE = GROUPCODE8.LEVEL6
			 left join EXTRACODE6 l7 ON l7.GROUPCODE = GROUPCODE8.LEVEL7
			 left join EXTRACODE6 l8 ON l8.GROUPCODE = GROUPCODE8.LEVEL8 
			 left join EXTRACODE6 l9 ON l9.GROUPCODE = GROUPCODE8.LEVEL9
		where l1.GROUPCODE = GROUPCODE8.LEVEL1
  ) AS GROUPCODE8DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
'
ELSE
SET @GRoupCode8PartCrossApply =''
IF @groupCode9 =1
  ...
  outer apply (
	select
		...
		from EXTRACODE7 as l1 with (nolock)
			 left join EXTRACODE7 l2 ON l2.GROUPCODE = GROUPCODE9.LEVEL2    
			 left join EXTRACODE7 l3 ON l3.GROUPCODE = GROUPCODE9.LEVEL3
			 left join EXTRACODE7 l4 ON l4.GROUPCODE = GROUPCODE9.LEVEL4
			 left join EXTRACODE7 l5 ON l5.GROUPCODE = GROUPCODE9.LEVEL5
			 left join EXTRACODE7 l6 ON l6.GROUPCODE = GROUPCODE9.LEVEL6
			 left join EXTRACODE7 l7 ON l7.GROUPCODE = GROUPCODE9.LEVEL7
			 left join EXTRACODE7 l8 ON l8.GROUPCODE = GROUPCODE9.LEVEL8 
			 left join EXTRACODE7 l9 ON l9.GROUPCODE = GROUPCODE9.LEVEL9
		where l1.GROUPCODE = GROUPCODE9.LEVEL1
  ) AS GROUPCODE9DATA(CODE1,TITLE1,DESCRIPTION1,UNIT1,UFACT1,CODE2,TITLE2,DESCRIPTION2,UNIT2,UFACT2,CODE3,TITLE3,DESCRIPTION3,UNIT3,UFACT3,CODE4,TITLE4,DESCRIPTION4,UNIT4,UFACT4,CODE5,TITLE5,DESCRIPTION5,UNIT5,UFACT5,CODE6,TITLE6,DESCRIPTION6,UNIT6,UFACT6,CODE7,TITLE7,DESCRIPTION7,UNIT7,UFACT7,CODE8,TITLE8,DESCRIPTION8,UNIT8,UFACT8,CODE9,TITLE9,DESCRIPTION9,UNIT9,UFACT9) 
'
ELSE
SET @GRoupCode9PartCrossApply =''
...
SET @SqlQuery =
'
'+@MainPart1+@MainPartIntermediate+@MainPart2+'
...
left outer join UNITALIAS as ua1 ON ua1.FRUNIT = o.UNIT
left outer join UNITALIAS as ua2 ON ua2.FRUNIT = o.SECOND_UNIT
...
-- JOIN PROJECT PROPERTIES IN k
  (SELECT 
	...
	FROM (select PKEY,PVAL from '+@Dbname+'.dbo.PRJPROP with (nolock) WHERE PKEY LIKE ' + CHAR(39) + 'pro%' + CHAR(39) + '  AND PRJID = ' + cast(@PrjId as varchar(max)) + ') PropTable PIVOT
	(
