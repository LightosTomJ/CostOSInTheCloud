...
namespace Helper.DB.Local
{
	public class BcElemConnectionsService
	{
		...
		{
			IList<Models.DB.Local.BcElemConnection> BcElemConnections = new List<Models.DB.Local.BcElemConnection>();
			try
			{
				if (localContext == null) localContext = new LocalContext();
		...
		public async Task<bool> UpdateBcElemConnection(long id, Models.DB.Local.BcElemConnection bcElemConnection)
		{
			try
			{
				if (localContext == null) localContext = new LocalContext();
