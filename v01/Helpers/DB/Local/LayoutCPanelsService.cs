...
namespace Helper.DB.Local
{
	public class LayoutCPanelsService
	{
		...
		{
			IList<Models.DB.Local.LayoutCPanel> LayoutCPanels = new List<Models.DB.Local.LayoutCPanel>();
			try
			{
				if (localContext == null) localContext = new LocalContext();
		...
		public async Task<bool> UpdateLayoutCPanel(long id, Models.DB.Local.LayoutCPanel layoutCPanel)
		{
			try
			{
				if (localContext == null) localContext = new LocalContext();
