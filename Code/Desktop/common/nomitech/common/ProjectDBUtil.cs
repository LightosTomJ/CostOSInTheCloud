...
namespace Desktop.common.nomitech.common
{
	...
	using LocationCache = Desktop.common.nomitech.common.db.cache.LocationCache;
	using ParamItemCache = Desktop.common.nomitech.common.db.cache.ParamItemCache;
	using ProjectVariableCache = Desktop.common.nomitech.common.db.cache.ProjectVariableCache;
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
	  ...
	  {
		System.Collections.IList list = listPropertyColumns(paramPersistentClass);
	  ...
	  public virtual IList<Column> listNonPropertyColumns(PersistentClass paramPersistentClass)
	  {
		...
		System.Collections.IList list = listPropertyColumns(paramPersistentClass);
		System.Collections.IEnumerator iterator = paramPersistentClass.RootTable.ColumnIterator;
		while (iterator.MoveNext())
		{
