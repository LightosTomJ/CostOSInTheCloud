...
namespace Desktop.common.nomitech.common.migration
{
	...
	public class RSMeansMigrationUtil2017
	{
	  private const bool ONLINE_REFERENCE = false;

	  private const string EDITION = "2017";

	  private const string SMALLEDITION = "17";
...
//ORIGINAL LINE: private RSMeansMigrationUtil2017(String paramString) throws Exception
	  private RSMeansMigrationUtil2017(string paramString)
	  {
		this.unitCostDataFolder = paramString + File.separator + "Unit Cost Data " + "2017";
		this.assembliesDataFolder = paramString + File.separator + "Assemblies Data " + "2017";
	  ...
	  private string getAssembliesReferenceString(string paramString)
	  {
		...
		return (string.ReferenceEquals(str, null)) ? "" : ("\nPDF: http://www.costdatabase.eu/rsmeans/17/as/pdf/" + str + ".PDF");
	  }

	  private string getAssembliesReferenceURL(string paramString)
	  {
		string str = (string)this.referenceAssembliesPDF[paramString];
		return (string.ReferenceEquals(str, null)) ? "" : ("http://www.costdatabase.eu/rsmeans/17/as/pdf/" + str + ".PDF");
	  }
...
//ORIGINAL LINE: private void doRename(String paramString) throws Exception
	  ...
	  private IDictionary<string, string> cacheUnitCostReferencePDF()
	  {
		...
		File file = new File(this.referenceFolder + File.separator + "Unit Cost" + File.separator + "Unit Cost References" + "2017" + ".txt");
	  ...
	  {
		Hashtable hashMap = new Hashtable();
		File file = new File(this.referenceFolder + File.separator + "Assembly" + File.separator + "Assembly References " + "2017" + ".txt");
	  ...
	  {
		Hashtable hashMap = new Hashtable();
		File file = new File(this.referenceFolder + File.separator + "Unit Cost" + File.separator + "Unit Cost Graphics" + "2017" + ".txt");
	  ...
	  {
		Hashtable hashMap = new Hashtable();
		File file = new File(this.referenceFolder + File.separator + "Assembly" + File.separator + "Assembly Graphics " + "2017" + ".txt");
...
//ORIGINAL LINE: private System.Nullable<long> loadCCI(String paramString) throws Exception
	  ...
	  {
		  return CCIToLocalizationLoader.loadUnitCCI(paramString, this.LOCATION_PROFILE_ID.Equals("O"), "CCI2017");
	  }

	  private void loadMasterFormat()
	  {
		Console.WriteLine("\n\n\nLOADING: MF14.CSI");
		this.masterFormat04Map = MasterFormatLoader.loadCSI(this.unitCostDataFolder, this.assembliesDataFolder, "MF14.CSI");
	  }

	  private void loadUniFormat()
	  {
		Console.WriteLine("\n\n\nLOADING: UNIFORMAT II");
		this.uniFormatMap = UniFormatLoader.loadUniFormat(this.assembliesDataFolder, "ASMUNI17");
	  }
...
//ORIGINAL LINE: private nomitech.common.base.GroupCode checkAndGetCSI(String paramString1, String paramString2, org.hibernate.Session paramSession) throws Exception
	  private GroupCode checkAndGetCSI(string paramString1, string paramString2, Session paramSession)
	  {
		...
		if (extraCode1Table == null)
		{
		  ...
		  ((ExtraCode1Table)extraCode1Table).GroupCode = StringUtils.convert8digitCodetoDotit(paramString1);
...
//ORIGINAL LINE: private org.hibernate.Transaction saveAssembliesData(org.hibernate.Session paramSession, String paramString1, String paramString2) throws Exception
	  ...
	  {
		File file1 = new File(this.assembliesDataFolder + File.separator + paramString1 + File.separator + "ASMDES" + "17" + "." + paramString2);
		File file2 = new File(this.assembliesDataFolder + File.separator + paramString1 + File.separator + "ASSMUP" + "17" + "." + paramString2);
		File file3 = new File(this.assembliesDataFolder + File.separator + paramString1 + File.separator + "ASSM" + "2017" + "." + paramString2);
...
//ORIGINAL LINE: private org.hibernate.Transaction saveUnitCostData(org.hibernate.Session paramSession, String paramString1, String paramString2) throws Exception
	  ...
	  {
		File file = new File(this.unitCostDataFolder + File.separator + paramString1 + File.separator + paramString2 + "2017" + ".SEQ");
...
//ORIGINAL LINE: private void loadEquipments(org.hibernate.Session paramSession) throws Exception
	  ...
	  {
		File file = new File(this.laborCrewFolder + File.separator + "EQM" + "2017" + ".SEQ");
		if (!RSMeansUOMConverter.CONVERT_TO_METRIC)
		{
		  file = new File(this.laborCrewFolder + File.separator + "EQ" + "2017" + ".SEQ");
		}
		StreamReader bufferedReader = new StreamReader(file);
		while (true)
		{
...
//ORIGINAL LINE: public static void migrateFromFolder(String paramString) throws Exception
	  ...
	  {
		  new RSMeansMigrationUtil2017(paramString);
	  }
	}


	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\migration\RSMeansMigrationUtil2017.class
