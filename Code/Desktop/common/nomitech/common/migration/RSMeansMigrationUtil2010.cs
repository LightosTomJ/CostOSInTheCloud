...
namespace Desktop.common.nomitech.common.migration
{
	...
	public class RSMeansMigrationUtil2010
	{
	  private const bool ONLINE_REFERENCE = true;

	  private const string EDITION = "2010";

	  private const string SMALLEDITION = "10";
	  ...
	  private string LOCATION_PROFILE_ID = "O3";
	  ...
	  private void init()
	  {
		this.UNITCOST_FILES_TO_MIGRATE["BCCD"] = "BCCD";
		this.UNITCOST_FILES_TO_MIGRATE["CIVL"] = "Civil";
		this.UNITCOST_FILES_TO_MIGRATE["COMM"] = "Commercial";
		this.UNITCOST_FILES_TO_MIGRATE["CONC"] = "Concrete";
		this.UNITCOST_FILES_TO_MIGRATE["ELEC"] = "Electrical";
		this.UNITCOST_FILES_TO_MIGRATE["FACL"] = "Facility";
		this.UNITCOST_FILES_TO_MIGRATE["GRN"] = "Green Building";
		this.UNITCOST_FILES_TO_MIGRATE["HVY"] = "Heavy";
		this.UNITCOST_FILES_TO_MIGRATE["INTR"] = "Interior";
		this.UNITCOST_FILES_TO_MIGRATE["LITE"] = "Light Commercial";
		this.UNITCOST_FILES_TO_MIGRATE["MSTR"] = "Master";
		this.UNITCOST_FILES_TO_MIGRATE["MECH"] = "Mechanical";
		this.UNITCOST_FILES_TO_MIGRATE["OPEN"] = "Open Shop";
		this.UNITCOST_FILES_TO_MIGRATE["PLUM"] = "Plumbing";
		this.UNITCOST_FILES_TO_MIGRATE["R&R"] = "Repair-Remodeling";
		this.UNITCOST_FILES_TO_MIGRATE["RESI"] = "Residential";
		this.UNITCOST_FILES_TO_MIGRATE["SITE"] = "Site Work";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Assembly"] = "ASM";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Civil"] = "CVL";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Commercial"] = "COM";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Concrete"] = "CON";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Electrical"] = "ELE";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Facility"] = "FAC";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Green Building"] = "GRN";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Heavy"] = "HVY";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Interior"] = "INT";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Master"] = "ALL";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Mechanical"] = "MEC";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Plumbing"] = "PLU";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Site Work"] = "SIT";
		this.ASSEMBLIES_FILES_TO_MIGRATE["Square Foot"] = "SF";
	  }

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private RSMeansMigrationUtil2010(String paramString) throws Exception
	  private RSMeansMigrationUtil2010(string paramString)
	  {
		this.unitCostDataFolder = paramString + File.separator + "Unit Cost Data " + "2010";
		this.assembliesDataFolder = paramString + File.separator + "Assemblies Data " + "2010";
		...
		{
		  this.crewMetCache = cacheCrew("MET2010");
		}
		else
		{
		  this.crewMetCache = cacheCrew("STD2010");
		}
		...
		try
		{
		  ...
		  this.laborOpenCache = cacheAndLoadLabors(session, "OPEN2010", ", Open Shop or Light Commercial Rate");
		  this.laborResiCache = cacheAndLoadLabors(session, "RESI2010", ", Residential Rate");
		  this.laborRRCache = cacheAndLoadLabors(session, "RR2010", ", Repair & Remodeling or Facility Rate");
		  this.laborStandardCache = cacheAndLoadLabors(session, "STD2010", "");
		  if (RSMeansUOMConverter.CONVERT_TO_METRIC)
		  {
			this.equCrewCache = cacheAndLoadEquipment(session, "EQM2010");
		  }
		  else
		  {
			this.equCrewCache = cacheAndLoadEquipment(session, "EQ2010");
		  }
	  ...
	  private string getAssembliesGraphicString(string paramString)
	  {
		...
		return (string.ReferenceEquals(str, null)) ? "" : ("\nGRAPHIC: http://www.costdatabase.eu/rsmeans/as/graphics/" + str + ".PDF");
	  }

	  private string getAssembliesGraphicURL(string paramString)
	  {
		string str = (string)this.graphicsAssembliesPDF[paramString];
		return (string.ReferenceEquals(str, null)) ? "" : ("http://www.costdatabase.eu/rsmeans/as/graphics/" + str + ".PDF");
	  }
	  ...
	  private string getAssembliesReferenceString(string paramString)
	  {
		...
		return (string.ReferenceEquals(str, null)) ? "" : ("\nPDF: http://www.costdatabase.eu/rsmeans/as/pdf/" + str + ".PDF");
	  }

	  private string getAssembliesReferenceURL(string paramString)
	  {
		string str = (string)this.referenceAssembliesPDF[paramString];
		return (string.ReferenceEquals(str, null)) ? "" : ("http://www.costdatabase.eu/rsmeans/as/pdf/" + str + ".PDF");
	  }
...
//ORIGINAL LINE: private void doRename(String paramString) throws Exception
	  ...
	  private IDictionary<string, string> cacheUnitCostReferencePDF()
	  {
		...
		File file = new File(this.referenceFolder + File.separator + "Unit Cost" + File.separator + "Unit Cost References" + "2010" + ".txt");
	  ...
	  {
		Hashtable hashMap = new Hashtable();
		File file = new File(this.referenceFolder + File.separator + "Assembly" + File.separator + "Assembly References " + "2010" + ".txt");
	  ...
	  {
		Hashtable hashMap = new Hashtable();
		File file = new File(this.referenceFolder + File.separator + "Unit Cost" + File.separator + "Unit Cost Graphics" + "2010" + ".txt");
	  ...
	  {
		Hashtable hashMap = new Hashtable();
		File file = new File(this.referenceFolder + File.separator + "Assembly" + File.separator + "Assembly Graphics " + "2010" + ".txt");
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void loadCCI(String paramString) throws Exception
	  private void loadCCI(string paramString)
	  {
		  CCIToLocalizationLoader.loadUnitCCI(paramString, this.LOCATION_PROFILE_ID.Equals("O"), "CCI2014");
	  }

	  private void loadMasterFormat()
	  {
		Console.WriteLine("\n\n\nLOADING: MF04.CSI");
		this.masterFormat04Map = MasterFormatLoader.loadCSI(this.unitCostDataFolder, this.assembliesDataFolder, "MF04.CSI");
	  }
...
//ORIGINAL LINE: private nomitech.common.base.GroupCode checkAndGetCSI(String paramString1, String paramString2, org.hibernate.Session paramSession) throws Exception
	  ...
	  private void loadUnitCostAndAssembliesData()
	  {
		...
		{
		  Console.WriteLine("///////////////////////////////////////");
		  Console.WriteLine("// UNIT COST DATA 2010               //");
		  Console.WriteLine("///////////////////////////////////////\n\n\n");
		  ...
		  Console.WriteLine("///////////////////////////////////////");
		  Console.WriteLine("// ASSEMBLIES DATA 2010              //");
		  Console.WriteLine("///////////////////////////////////////");
...
//ORIGINAL LINE: private org.hibernate.Transaction saveAssembliesData(org.hibernate.Session paramSession, String paramString1, String paramString2) throws Exception
	  ...
	  {
		File file1 = new File(this.assembliesDataFolder + File.separator + paramString1 + File.separator + "ASMDES" + "10" + "." + paramString2);
		File file2 = new File(this.assembliesDataFolder + File.separator + paramString1 + File.separator + "ASSMUP" + "10" + "." + paramString2);
		File file3 = new File(this.assembliesDataFolder + File.separator + paramString1 + File.separator + "ASSM" + "2010" + "." + paramString2);
...
//ORIGINAL LINE: private nomitech.common.base.BaseTableItem loadOrCreateBaseTableItem(org.hibernate.Session paramSession, String paramString1, String paramString2) throws Exception
	  private BaseTableItem loadOrCreateBaseTableItem(Session paramSession, string paramString1, string paramString2)
	  {
		...
		string str2 = StringUtils.removeSpacesFromEnd(paramString1.Substring(299, 5));
		...
		BaseTableItem baseTableItem = new BaseTableItem(subcontractorTable, true);
		if (!this.USE_COST_BOOK_DUPLICATES)
		{
...
//ORIGINAL LINE: private nomitech.common.base.BaseTableItem loadBaseTableItem(org.hibernate.Session paramSession, String paramString1, String paramString2) throws Exception
	  ...
	  {
		BaseTableItem baseTableItem = (BaseTableItem)BaseTableItem.loadItems(paramSession, new string[] {paramString1}, true)[0];
...
//ORIGINAL LINE: private org.hibernate.Transaction saveUnitCostData(org.hibernate.Session paramSession, String paramString1, String paramString2) throws Exception
	  ...
	  {
		File file = new File(this.unitCostDataFolder + File.separator + paramString1 + File.separator + paramString2 + "2010" + ".SEQ");
		...
		while (true)
		{
		  ...
		  {
			this.DISTINCT_VALUES_MAP[str2 + d2] = (new BaseTableItem(subcontractorTable, true)).ToString();
		  }
		  if (this.PROGRESS_SHOW_INTERVAL != -1 && i % this.PROGRESS_SHOW_INTERVAL == 0)
		  {
			Console.WriteLine(paramString2 + " PROCESSED: " + i);
...
//ORIGINAL LINE: private void loadEquipments(org.hibernate.Session paramSession) throws Exception
	  ...
	  {
		File file = new File(this.laborCrewFolder + File.separator + "EQM" + "2010" + ".SEQ");
		if (!RSMeansUOMConverter.CONVERT_TO_METRIC)
		{
		  file = new File(this.laborCrewFolder + File.separator + "EQ" + "2010" + ".SEQ");
		}
		StreamReader bufferedReader = new StreamReader(file);
		while (true)
		{
...
//ORIGINAL LINE: private nomitech.common.db.local.AssemblyTable saveOrUpdateAssemblyTable(org.hibernate.Session paramSession, nomitech.common.base.GroupCode paramGroupCode, String paramString1, String paramString2, double paramDouble1, double paramDouble2, String paramString3, double paramDouble3, String paramString4, String paramString5, nomitech.common.db.local.MaterialTable paramMaterialTable, java.util.Map<String, Desktop.common.nomitech.common.migration.rsmeans.RSMeansLaborItem> paramMap, String paramString6, double paramDouble4, String paramString7) throws Exception
	  private AssemblyTable saveOrUpdateAssemblyTable(Session paramSession, GroupCode paramGroupCode, string paramString1, string paramString2, double paramDouble1, double paramDouble2, string paramString3, double paramDouble3, string paramString4, string paramString5, MaterialTable paramMaterialTable, IDictionary<string, RSMeansLaborItem> paramMap, string paramString6, double paramDouble4, string paramString7)
	  {
		...
		assemblyTable.Description = paramString2 + ", SK: " + paramString5 + ", MF04: " + paramString1 + ", CB: " + paramString6 + getUnitCostReferenceString(paramGroupCode.getGroupCode()) + getUnitCostGraphicString(paramString1);
...
//ORIGINAL LINE: private nomitech.common.db.local.SubcontractorTable saveOrUpdateSubcontractorTable(org.hibernate.Session paramSession, nomitech.common.base.GroupCode paramGroupCode, String paramString1, String paramString2, double paramDouble1, double paramDouble2, String paramString3, String paramString4, String paramString5, String paramString6) throws Exception
	  private SubcontractorTable saveOrUpdateSubcontractorTable(Session paramSession, GroupCode paramGroupCode, string paramString1, string paramString2, double paramDouble1, double paramDouble2, string paramString3, string paramString4, string paramString5, string paramString6)
	  {
		...
		null.Description = paramString2 + ", SK: " + paramString4 + ", MF04: " + paramString1 + ", CB: " + paramString5 + getUnitCostReferenceString(paramGroupCode.getGroupCode()) + getUnitCostGraphicString(paramString1);
		null.LastUpdate = this.lastUpdate;
		null.CreateDate = this.lastUpdate;
		null.CreateUserId = "rsmeans";
...
//ORIGINAL LINE: private nomitech.common.db.local.EquipmentTable saveOrUpdateEquipmentTable(org.hibernate.Session paramSession, nomitech.common.base.GroupCode paramGroupCode, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, double paramDouble, String paramString6) throws Exception
	  private EquipmentTable saveOrUpdateEquipmentTable(Session paramSession, GroupCode paramGroupCode, string paramString1, string paramString2, string paramString3, string paramString4, string paramString5, double paramDouble, string paramString6)
	  {
		...
		if (string.ReferenceEquals(str, null))
		{
		  throw new Exception("FATAL: UNIT WAS NULL FOR " + paramString6 + ". AND MF04 " + paramString1);
		}
		null.Unit = "HOUR";
		if (str.Equals("DAY"))
		{
		...
		null.Notes = "MF04: " + paramString1;
		null.Description = paramString3 + paramString4 + paramString5 + ", SK:" + paramString2 + ", MF04: " + paramString1 + getUnitCostReferenceString(paramGroupCode.getGroupCode()) + getUnitCostGraphicString(paramString1);
		null.LastUpdate = this.lastUpdate;
		null.CreateDate = this.lastUpdate;
		null.CreateUserId = "rsmeans";
...
//ORIGINAL LINE: public static void migrateFromFolder(String paramString) throws Exception
	  ...
	  {
		  new RSMeansMigrationUtil2010(paramString);
	  }
	}


	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\migration\RSMeansMigrationUtil2010.class
