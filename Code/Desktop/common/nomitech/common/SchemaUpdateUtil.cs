...
namespace Desktop.common.nomitech.common
{
	...
	using BoqMetadataTable = Desktop.common.nomitech.common.db.local.BoqMetadataTable;
	using CountryTable = Desktop.common.nomitech.common.db.local.CountryTable;
	using CurrencyTable = Desktop.common.nomitech.common.db.local.CurrencyTable;
