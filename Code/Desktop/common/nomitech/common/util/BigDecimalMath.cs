...
namespace Desktop.common.nomitech.common.util
{
	...
	public class BigDecimalMath
	{
	  ...
	  public static decimal ONE = decimal.One;

	  public static decimal TWO = new decimal("2");

	  public static decimal THREE = new decimal("3");

	  public static decimal FOUR = new decimal("4");

	  public static decimal NINE = new decimal("9");

	  public static decimal TEN = new decimal("10");

	  public static decimal NEG_ONE = new decimal("-1");

	  public static decimal HALF = new BigDecimalFixed("0.5");

	  public static decimal HUNDREND = new BigDecimalFixed("100");

	  public static decimal POINT99 = new BigDecimalFixed("0.99");

	  public static decimal MAX_DATABASE_NUMBER = new decimal("9999999999999999999.999999999");

	  public static int DEC_PLACES = 15;

	  public static int MAX_PLACES = DEC_PLACES + 5;

	  private static int CMP_BIAS = 5;

	  private static int CMP_PLACES = DEC_PLACES - CMP_BIAS;

	  public static int CALC_PLACES = DEC_PLACES - 4;

	  public static decimal CALC_PRECISION = ONE.movePointLeft(CALC_PLACES);

	  public static int APPROX_EQ_PLACES = DEC_PLACES - 4;

	  public static int APPROX_3_DIGITS = 3;

	  public static decimal E = taylor(ONE, ONE, ZERO, 1, false);

	  public static decimal PI = ComputePi();

	  private static decimal ONE_HUND = new BigDecimalFixed("100");

	  private static decimal ONE_TENTH = new BigDecimalFixed("0.1");
	  ...
	  private static decimal X180 = new BigDecimalFixed("180");
	  ...
	  public static decimal mult(decimal paramBigDecimal1, decimal paramBigDecimal2)
	  {
		...
		return bigDecimal.setScale(MAX_PLACES, ROUND_DOWN);
	  }
	  ...
	  public static decimal div(decimal paramBigDecimal1, decimal paramBigDecimal2)
	  {
		...
		decimal bigDecimal = paramBigDecimal1.setScale(MAX_PLACES, ROUND_DOWN);
	  ...
	  {
		  return (paramBigDecimal1 == null && paramBigDecimal2 == null) ? 0 : ((paramBigDecimal1 != null && paramBigDecimal2 == null) ? 1 : ((paramBigDecimal1 == null && paramBigDecimal2 != null) ? -1 : approx(paramBigDecimal1, paramBigDecimal2, CMP_PLACES)));
	  }

	  public static int cmp(decimal paramBigDecimal1, decimal paramBigDecimal2)
	  {
		  return approx(paramBigDecimal1, paramBigDecimal2, CMP_PLACES);
	  }
	  ...
	  {
		  return isInt(paramBigDecimal, CMP_PLACES);
	  }
	  ...
	  public static decimal SmartRound(decimal paramBigDecimal, int paramInt)
	  {
		...
		while (b2 < DEC_PLACES - paramInt)
		{
		  ...
		  if (approx(bigDecimal1, ZERO, paramInt) == 0 || bool1)
		  {
			...
			null = null.setScale(MAX_PLACES, ROUND_DOWN).movePointLeft(b1);
			if (@bool)
			{
			  null = null.negate();
			}
	  ...
	  private static decimal ComputePi()
	  {
		...
		return bigDecimal1.setScale(MAX_PLACES, ROUND_DOWN);
	  }
	  ...
	  {
		decimal bigDecimal1 = paramBigDecimal2.setScale(MAX_PLACES, ROUND_DOWN);
		null = bigDecimal1;
		...
		return null.setScale(DEC_PLACES, ROUND_DOWN);
	  }
	  ...
	  public static decimal ln(decimal paramBigDecimal)
	  {
		...
		decimal bigDecimal1 = paramBigDecimal - ONE.setScale(MAX_PLACES, ROUND_DOWN);
		...
		return bigDecimal4.setScale(DEC_PLACES, ROUND_DOWN);
	  }

	  private static decimal logSeries(decimal paramBigDecimal)
	  {
		decimal bigDecimal1 = paramBigDecimal.setScale(MAX_PLACES, ROUND_DOWN);
	  ...
	  public static decimal root(int paramInt, decimal paramBigDecimal)
	  {
		...
		paramBigDecimal = paramBigDecimal.setScale(MAX_PLACES, ROUND_DOWN);
		decimal bigDecimal = realRoot(paramInt, paramBigDecimal);
		if (b < 0)
		{
		  bigDecimal = -bigDecimal;
		}
		return bigDecimal.setScale(DEC_PLACES, ROUND_DOWN);
	  }
	  ...
	  private static decimal realRoot(int paramInt, decimal paramBigDecimal)
	  {
		...
		paramBigDecimal = paramBigDecimal.abs().setScale(MAX_PLACES, ROUND_DOWN);
		BigDecimalFixed bigDecimalFixed = new BigDecimalFixed("" + paramInt);
		decimal bigDecimal1 = bigDecimalFixed.subtract(ONE);
		bigDecimal1 = bigDecimal1.setScale(MAX_PLACES, ROUND_DOWN).divide(bigDecimalFixed, ROUND_DOWN);
		...
		return bigDecimal3.setScale(DEC_PLACES, ROUND_DOWN);
	  }
	  ...
	  public static decimal atan2(decimal paramBigDecimal1, decimal paramBigDecimal2)
	  {
		...
		decimal bigDecimal1 = paramBigDecimal1.setScale(MAX_PLACES, ROUND_DOWN).divide(paramBigDecimal2, ROUND_DOWN);
	...
	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\commo\\util\BigDecimalMath.class
