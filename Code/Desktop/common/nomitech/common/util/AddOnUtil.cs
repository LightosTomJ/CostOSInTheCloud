...
namespace Desktop.common.nomitech.common.util
{
	...
	public class AddOnUtil
	{
	  ...
	  private static readonly sbyte[] DEFAULT_KEY = new sbyte[] {2, -28, -89, 18, 23, 36, 50, 68};
	  ...
	  public AddOnUtil(sbyte[] paramArrayOfByte, string paramString)
	  {
	  ...
	  {
		  return decryptString(toByteArray(paramString));
	  }
	...
	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\commo\\util\AddOnUtil.class
