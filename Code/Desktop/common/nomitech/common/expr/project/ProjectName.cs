...
namespace Desktop.common.nomitech.common.expr.project
{
	...
	public class ProjectName : AbstractFunction
	{
...
//ORIGINAL LINE: public org.boris.expr.Expr evaluate(org.boris.expr.IEvaluationContext paramIEvaluationContext, org.boris.expr.Expr[] paramArrayOfExpr) throws org.boris.expr.ExprException
	  public virtual Expr evaluate(IEvaluationContext paramIEvaluationContext, Expr[] paramArrayOfExpr)
	  {
		...
		try
		{
		  ...
		  if (paramIEvaluationContext is ExprAbstractEvaluationContext)
		  {
			...
			{
			  str = projectUrlTable.Name;
			}
			else if (string.ReferenceEquals(str, null))
			{
			  str = ProjectDBUtil.currentProjectDBUtil().Properties.getProperty("project.name");
			}
		  }
	...
	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\expr\project\ProjectName.class
