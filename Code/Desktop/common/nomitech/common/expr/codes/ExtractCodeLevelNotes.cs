...
namespace Desktop.common.nomitech.common.expr.codes
{
	...
	public class ExtractCodeLevelNotes : AbstractFunction
	{
...
//ORIGINAL LINE: public org.boris.expr.Expr evaluate(org.boris.expr.IEvaluationContext paramIEvaluationContext, org.boris.expr.Expr[] paramArrayOfExpr) throws org.boris.expr.ExprException
	  public virtual Expr evaluate(IEvaluationContext paramIEvaluationContext, Expr[] paramArrayOfExpr)
	  {
		...
		else
		{
		  ...
		  return (groupCode1 == null) ? new ExprString("") : new ExprString(groupCode1.Unit);
		}
		...
		{
		  return new ExprString(groupCode.Notes);
		}
		str2 = (string)arrayList[i];
		groupCode = s_groupCodeUtilIntf.extractCode(str1, str2);
		return (groupCode == null) ? new ExprString("") : new ExprString(groupCode.Notes);
	  }
	}


	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\expr\codes\ExtractCodeLevelNotes.class
