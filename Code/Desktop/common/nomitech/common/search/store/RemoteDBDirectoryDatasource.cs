...
namespace Desktop.common.nomitech.common.search.store
{
	...
	public class RemoteDBDirectoryDatasource : DataSource
	{
	  private string url;
	  ...
	  public RemoteDBDirectoryDatasource(string paramString1, string paramString2, string paramString3, string paramString4)
	  {
...
//ORIGINAL LINE: public java.sql.Connection getConnection() throws java.sql.SQLException
	  public virtual Connection Connection
	  {
		  get
		  {
			...
			return RemoteDBConnectionPool.getLocalDBConnection(this.url, properties);
		  }
	  }
...
//ORIGINAL LINE: public java.util.logging.Logger getParentLogger() throws java.sql.SQLFeatureNotSupportedException
	...
	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\search\store\RemoteDBDirectoryDatasource.class
