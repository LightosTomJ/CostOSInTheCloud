...
namespace Desktop.common.nomitech.common.search.store
{
	...
	public class RemoteDBDirectoryProvider : object, DirectoryProvider<JdbcDirectory>
	{
	  private JdbcDirectory directory;

	  private RemoteDBDirectoryDatasource dataSource;

	  private Dialect dialect;

	  private string tableName;

	  public virtual void initialize(string paramString, Properties paramProperties)
	  {
		  initialize(paramString, paramProperties, (SearchFactoryImplementor)null);
	  }
	...
	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\search\store\RemoteDBDirectoryProvider.class
