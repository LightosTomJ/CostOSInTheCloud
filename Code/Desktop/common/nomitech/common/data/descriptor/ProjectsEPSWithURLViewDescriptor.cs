namespace Desktop.common.nomitech.common.data.descriptor
{
	...
	public class ProjectsEPSWithURLViewDescriptor : BaseViewDescriptor
	{
	  private static ProjectsEPSWithURLViewDescriptor s_instance = null;
	  ...
	  private readonly DataObjectDescriptor[] ALL_FIELDS = new DataObjectDescriptor[]
	  {
		  ...
		  new DataObjectDescriptor("projectUrlId", "projectUrl.PROJECTURLID", "Project URL ID", "Long"),
		  new DataObjectDescriptor("projectUrlName", "projectUrl.NAME", UILanguage.get("tab.projectdetails.table.name"), "Text"),
		  new DataObjectDescriptor("projectUrlRevisionName", "projectUrl.RVSON", "Project URL Revision Name", "Text"),
		  new DataObjectDescriptor("projectUrlType", "projectUrl.TYPE", UILanguage.get("tab.pselect.column.projectType"), "Text"),
		  new DataObjectDescriptor("projectUrlIsDefaultRevision", "projectUrl.DEFREV", "Default Revision ", "Boolean"),
		  new DataObjectDescriptor("projectUrlEditorId", "projectUrl.EDITORID", "Default Editor ID ", "Text"),
		  new DataObjectDescriptor("projectUrlLastUpdate", "projectUrl.LASTUPDATE", "Project Last Update ", "Date"),
		  new DataObjectDescriptor("projectUrlDatabaseEngine", "projectUrl.DBSRV", "Database Engine", "Integer"),
		  new DataObjectDescriptor("projectUrlDatabaseName", "projectUrl.DBNAME", UILanguage.get("tree.databasetabname"), "Text"),
		  new DataObjectDescriptor("projectUrlDatabaseHostname", "projectUrl.DBHOST", UILanguage.get("dialog.prjdb.hostname.label"), "Text"),
		  new DataObjectDescriptor("projectUrlDatabasePort", "projectUrl.DBPORT", UILanguage.get("dialog.prjdb.hostname.label"), "Text")
	  };

	  public static ProjectsEPSWithURLViewDescriptor Instance
	  {
		  get
		  {
			if (s_instance == null)
			{
			  s_instance = new ProjectsEPSWithURLViewDescriptor();
			}
			return s_instance;
		  }
	  }
	...
	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\data\descriptor\ProjectsEPSWithURLViewDescriptor.class
