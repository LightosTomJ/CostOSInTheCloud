...
namespace Desktop.common.nomitech.common.logging.log4jboss
{
	...
	using XLevel = Desktop.common.org.jboss.logging.XLevel;
	...
	internal class Log4jLogger : Logger
	{
	  ...
	  {
		  this.logger.log(XLevel.TRACE, paramObject);
	  }
	  ...
	  {
		  this.logger.log(XLevel.TRACE, paramObject, paramThrowable);
	  }
	  ...
	  public override bool TraceEnabled
	  {
		  get
		  {
			XLevel xLevel = XLevel.TRACE;
			return !this.logger.isEnabledFor(xLevel) ? false : xLevel.isGreaterOrEqual(this.logger.EffectiveLevel);
		  }
	  }
	}


	/* Location:              C:\Users\TomJames_zyl8law\Lightos\Lightos Hub - Documents\01-Clients\CostOS\Solution from Java Source Code\common\!\nomitech\common\logging\log4jboss\Log4jLogger.class
