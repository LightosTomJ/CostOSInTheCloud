...
namespace Desktop.common.nomitech.ces
{
    ...
    using ConsumableTable = Desktop.common.nomitech.common.db.local.ConsumableTable;
    using EquipmentTable = Desktop.common.nomitech.common.db.local.EquipmentTable;
    using ExtraCode1Table = Desktop.common.nomitech.common.db.local.ExtraCode1Table;
    using ExtraCode2Table = Desktop.common.nomitech.common.db.local.ExtraCode2Table;
    using ExtraCode3Table = Desktop.common.nomitech.common.db.local.ExtraCode3Table;
    using ExtraCode4Table = Desktop.common.nomitech.common.db.local.ExtraCode4Table;
    using ExtraCode5Table = Desktop.common.nomitech.common.db.local.ExtraCode5Table;
    using ExtraCode6Table = Desktop.common.nomitech.common.db.local.ExtraCode6Table;
    using ExtraCode7Table = Desktop.common.nomitech.common.db.local.ExtraCode7Table;
    using GekCodeTable = Desktop.common.nomitech.common.db.local.GekCodeTable;
    using GroupCodeTable = Desktop.common.nomitech.common.db.local.GroupCodeTable;
    using LaborTable = Desktop.common.nomitech.common.db.local.LaborTable;
    using MaterialTable = Desktop.common.nomitech.common.db.local.MaterialTable;
    using ParamItemTable = Desktop.common.nomitech.common.db.local.ParamItemTable;org	using ProjectInfoTable = Desktop.common.nomitech.common.db.local.ProjectInfoTable;
    using ProjectWBSTable = Desktop.common.nomitech.common.db.local.ProjectWBSTable;
    using SubcontractorTable = Desktop.common.nomitech.common.db.local.SubcontractorTable;
