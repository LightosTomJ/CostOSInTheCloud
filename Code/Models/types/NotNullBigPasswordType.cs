...
namespace Models.types
{
	...
	using Hibernate = org.hibernate.Hibernate;
	...
	public class NotNullBigPasswordType : UserType
	{

		public NotNullBigPasswordType() : base()
		{
		}
...
//ORIGINAL LINE: public void nullSafeSet(java.sql.PreparedStatement st, Object value, int index) throws org.hibernate.HibernateException, java.sql.SQLException
		public virtual void nullSafeSet(PreparedStatement st, object value, int index)
		{
			...
			//Hibernate.STRING.nullSafeSet(arg0, (arg1 != null) ? ((((String) arg1).length() > 0) ? CryptUtil.getInstance().encryptHexString(arg1.toString()) : PENTAHOEMPTY) : arg1, arg2);
		}
