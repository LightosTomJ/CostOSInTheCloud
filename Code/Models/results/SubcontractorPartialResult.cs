...
namespace Models.result
{
    ...
    public class SubcontractorPartialResult
    {
        ...
        public SubcontractorPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool ascending, string query, string queryType, double seconds, int? pageSize, IList<SubcontractorTable> partialResult) : base()
        {
