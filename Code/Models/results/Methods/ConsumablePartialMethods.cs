...
namespace Model.result
{
	...
	public class ConsumablePartialResult : IPartialResult
	{
		...
		private IList<ConsumableTable> partialResult;
		...
		public ConsumablePartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<ConsumableTable> partialResult) : base()
		{
		...
		public virtual IList<ConsumableTable> PartialResult
		{
			get
			{
