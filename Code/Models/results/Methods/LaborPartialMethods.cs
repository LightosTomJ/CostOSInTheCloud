...
namespace Model.results.Methods
{
    ...
    public class LaborPartialResult //: IPartialResult
	{
		...
		//private IList<LaborTable> partialResult;
		...
		//public LaborPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<LaborTable> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<LaborTable> PartialResult
		//{
		//	get
		//	{
