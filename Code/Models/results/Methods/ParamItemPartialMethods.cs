...
namespace Model.results.Methods
{
	...
	public class ParamItemPartialResult //: IPartialResult
	{
		...
		//private IList<ParamItemTable> partialResult;
		...
		//public ParamItemPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<ParamItemTable> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<ParamItemTable> PartialResult
		//{
		//	get
		//	{
