...
namespace Model.result
{
  ...
  //      public SupplierPartialMethods()
		//{
  //          // We need this constructor to initialize the webservice
  //      }

		//public SupplierPartialMethods(int? resultSize, int? partialSize, int? partialStart, 
  ...
  //      public IList Result => throw new NotImplementedException();
    }
