...
namespace Models.result
{
    ...
    public class MaterialPartialResult
    {
        ...
        public MaterialPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool ascending, string query, string queryType, double seconds, int? pageSize, IList<MaterialTable> partialResult) : base()
        {
