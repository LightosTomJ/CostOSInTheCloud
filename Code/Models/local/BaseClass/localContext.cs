...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\ProjectsV13;Initial Catalog=local;Integrated Security=True;Persist Security Info=False;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BcGeomfile>(entity =>
            {
                ...
                entity.HasIndex(e => e.Fguid)
                    .HasName("UQ__BC_GEOMF__B7D10E46BB1C4C6C")
                    .IsUnique();
            ...
            modelBuilder.Entity<BcScene>(entity =>
            {
                ...
                entity.HasIndex(e => e.Sguid)
                    .HasName("UQ__BC_SCENE__D7E1467357C74EEB")
                    .IsUnique();
            ...
            modelBuilder.Entity<Conceptuals>(entity =>
            {
                entity.HasKey(e => e.Conceptualid)
                    .HasName("PK__CONCEPTU__46D7EFE5B0211429");
            ...
            modelBuilder.Entity<Extracode1>(entity =>
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C941F3576202");
            ...
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C941E421DA9F");
            ...
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C9413957557D");
            ...
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C94103C3B296");
            ...
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C941AE7309DF");
            ...
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C941464BA012");
            ...
            {
                entity.HasKey(e => e.Groupcodeid)
                    .HasName("PK__EXTRACOD__7408C941889DD5C0");
            ...
            modelBuilder.Entity<Fncton>(entity =>
            {
                entity.HasKey(e => e.Functionid)
                    .HasName("PK__FNCTON__466C3FDF68302CEA");
            ...
            modelBuilder.Entity<FnctonArgument>(entity =>
            {
                entity.HasKey(e => e.Fargid)
                    .HasName("PK__FNCTON_A__E10CD26FEA21C316");
            ...
            modelBuilder.Entity<Principals>(entity =>
            {
                entity.HasKey(e => e.Principalid)
                    .HasName("PK__PRINCIPA__2CBDF6F4D68E76AA");
            ...
            modelBuilder.Entity<Roles>(entity =>
            {
                entity.HasKey(e => e.Roleid)
                    .HasName("PK__ROLES__006568E93D9CAFCD");
