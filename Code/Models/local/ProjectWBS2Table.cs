...
namespace Models.local
{
	...
	/// 
	/// @hibernate.class table="PROJECTWBS2"
	/// @hibernate.cache usage="nonstrict-read-write"
	/// </summary>
	//#RXL_END
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Indexed public class ProjectWBS2Table implements nomitech.common.base.GroupCode, nomitech.common.base.ItemCode, java.awt.datatransfer.Transferable, nomitech.common.base.ProjectIdEntity, java.io.Serializable, nomitech.common.base.BaseTable
	[Serializable]
	public class ProjectWBS2Table : GroupCode, ItemCode, Transferable, ProjectIdEntity, BaseTable
	{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) private String itemCode = null;
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) private String projectName = null;
		...
		private static readonly DataFlavor[] s_supportedDataFlavors = new DataFlavor[] {DataFlavors.projectWBS2DataFlavor};
	...
	//		if ( !(val instanceof ProjectWBS2Table) ) {
	//			return false;
	//		}
	//		final String lastUpdate = "lastUpdate";
	//		ProjectWBS2Table group = (ProjectWBS2Table)val;
	...
	//	}
		...
		public virtual ProjectWBS2Table Data
		{
			set
			{
	...
	//	public void setFieldData(String field, ProjectWBS2Table data) {
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.NO) public String getUnit_sorted()
		...
		public override GroupCode Data
		{
			set
			{
				Data = (ProjectWBS2Table)value;
			}
		}

		public override void setFieldData(string field, GroupCode groupCodeTable)
		{
			setFieldData(field,(ProjectWBS2Table)groupCodeTable);
		}
