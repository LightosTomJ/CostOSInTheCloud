...
namespace Models.local
{
	...
	/// 
	/// @hibernate.class table="EXTRACODE1"
	/// @hibernate.cache usage="nonstrict-read-write"
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Indexed public class ExtraCode1Table implements nomitech.common.base.GroupCode, java.awt.datatransfer.Transferable, java.io.Serializable, nomitech.common.base.BaseTable
	[Serializable]
	public class ExtraCode1Table : GroupCode, Transferable, BaseTable
	{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DocumentId private System.Nullable<long> extraCode1Id = null;
		private long? extraCode1Id = null;
		private string extraCode1 = null;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) private java.math.BigDecimal unitFactor = null;
		...
		private static readonly DataFlavor[] s_supportedDataFlavors = new DataFlavor[] {DataFlavors.extraCode1DataFlavor};
	...
	//		if ( !(val instanceof ExtraCode1Table) ) {
	//			return false;
	//		}
	//		final String lastUpdate = "lastUpdate";
	//		ExtraCode1Table group = (ExtraCode1Table)val;
	...
	//	}
		...
		public virtual ExtraCode1Table Data
		{
			set
			{
		...
		public virtual void setFieldData(string field, ExtraCode1Table data)
		{
		...
		public virtual long? ExtraCode1Id
		{
			get
			{
				return extraCode1Id;
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) public String getGroupCode()
		...
		{
			return DataFlavors.extraCode1DataFlavor.Equals(flavor);
		}
...
//ORIGINAL LINE: public synchronized Object getTransferData(java.awt.datatransfer.DataFlavor flavor) throws java.awt.datatransfer.UnsupportedFlavorException, java.io.IOException
		public virtual object getTransferData(DataFlavor flavor)
		{
			lock (this)
			{
				if (DataFlavors.extraCode1DataFlavor.Equals(flavor))
				{
					return this;
				}
		...
		{
			return extraCode1.CompareTo(o.GroupCode);
		}
		/////////////////////////////////////////////////////
		// SORTING FIELDS                                  //
		/////////////////////////////////////////////////////
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.NO) public java.util.Date getLastUpdate_sorted()
		...
		public override GroupCode Data
		{
			set
			{
				Data = (ExtraCode1Table)value;
			}
		}

		public override void setFieldData(string field, GroupCode groupCodeTable)
		{
			setFieldData(field,(ExtraCode1Table)groupCodeTable);
		}
