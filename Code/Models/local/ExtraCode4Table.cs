...
namespace Models.local
{
	...
	/// 
	/// @hibernate.class table="EXTRACODE4"
	/// @hibernate.cache usage="nonstrict-read-write"
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Indexed public class ExtraCode4Table implements nomitech.common.base.GroupCode, java.awt.datatransfer.Transferable, java.io.Serializable, nomitech.common.base.BaseTable
	[Serializable]
	public class ExtraCode4Table : GroupCode, Transferable, BaseTable
	{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DocumentId private System.Nullable<long> extraCode4Id = null;
		private long? extraCode4Id = null;
		private string extraCode4 = null;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) private java.math.BigDecimal unitFactor = null;
		...
		private static readonly DataFlavor[] s_supportedDataFlavors = new DataFlavor[] {DataFlavors.extraCode4DataFlavor};
	...
	//		if ( !(val instanceof ExtraCode4Table) ) {
	//			return false;
	//		}
	//		final String lastUpdate = "lastUpdate";
	//		ExtraCode4Table group = (ExtraCode4Table)val;
	...
	//	}
		...
		{
			ExtraCode4Table obj = new ExtraCode4Table();

			obj.ExtraCode4Id = ExtraCode4Id;
		...
		public virtual ExtraCode4Table Data
		{
			set
			{
		...
		public virtual void setFieldData(string field, ExtraCode4Table data)
		{
		...
		public virtual long? ExtraCode4Id
		{
			get
			{
				return extraCode4Id;
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) public String getGroupCode()
		...
		{
			return DataFlavors.extraCode4DataFlavor.Equals(flavor);
		}
...
//ORIGINAL LINE: public synchronized Object getTransferData(java.awt.datatransfer.DataFlavor flavor) throws java.awt.datatransfer.UnsupportedFlavorException, java.io.IOException
		public virtual object getTransferData(DataFlavor flavor)
		{
			lock (this)
			{
				if (DataFlavors.extraCode4DataFlavor.Equals(flavor))
				{
					return this;
				}
		...
		{
			return extraCode4.CompareTo(o.GroupCode);
		}
		/////////////////////////////////////////////////////
		// SORTING FIELDS                                  //
		/////////////////////////////////////////////////////
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.NO) public java.util.Date getLastUpdate_sorted()
		...
		public override GroupCode Data
		{
			set
			{
				Data = (ExtraCode4Table)value;
			}
		}

		public override void setFieldData(string field, GroupCode groupCodeTable)
		{
			setFieldData(field,(ExtraCode4Table)groupCodeTable);
		}
