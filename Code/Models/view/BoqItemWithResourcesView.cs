...
namespace Models.view
{
	...
	[Serializable]
	public class BoqItemWithResourcesView
	{
		...
		private DateTime assignmentLastUpdate;
		...
		private long? resourceDatabaseId;
		private long? resourceDatabaseCreationDateId;
		private string resourceItemCode;
		private string resourceTitle;
		private string resourceDescription;
		private string resourceNotes;
		private decimal resourceRate;
		private decimal resourceBuildUpRate;
		...
		private int? resourceOverrideType;
		...
		public virtual DateTime AssignmentLastUpdate
		{
			get
			{
				return assignmentLastUpdate;
			}
			set
			{
				this.assignmentLastUpdate = value;
			}
		}
		...
		public virtual long? ResourceDatabaseId
		{
			get
			{
			...
			set
			{
				this.resourceDatabaseId = value;
			}
		}
		public virtual long? ResourceDatabaseCreationDateId
		{
			get
			{
				return resourceDatabaseCreationDateId;
			}
			set
			{
				this.resourceDatabaseCreationDateId = value;
			}
		}
		public virtual string ResourceItemCode
		{
			get
			{
		...
		public virtual decimal ResourceBuildUpRate
		{
			get
			{
				return resourceBuildUpRate;
			}
			set
			{
				this.resourceBuildUpRate = value;
			}
		}
		...
		public virtual int? ResourceOverrideType
		{
			get
			{
				return resourceOverrideType;
			}
			set
			{
				this.resourceOverrideType = value;
			}
		}
	...
	//		public Id() {}
	//
	//		public Id(Long boqitemId, Long resourceId, String assignmentType) {
	//			super();
	...
	//				Id oId = (Id) obj;				
	//				return oId.toString().equals(toString());
	//			}
	//			return false;
	//		}
	//		
	//		public String toString() {
	//			return (resourceId==null?(""):(""+resourceId))+(assignmentType==null?(""):(assignmentType))+(boqitemId==null?(""):(""+boqitemId));
	//		}
	//
	//		@Override
	//		public int hashCode() {
