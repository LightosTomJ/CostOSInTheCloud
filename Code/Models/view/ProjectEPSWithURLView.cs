...
namespace Models.view
{
    ...
    public class ProjectEPSWithURLView
    {
        ...
        public string projectUrlRevisionName { get; set; }
        public string projectUrlType { get; set; }
        public bool? projectUrlIsDefaultRevision { get; set; }
        public string projectUrlEditorId { get; set; }

        public DateTime projectUrlLastUpdate { get; set; }
        public string projectUrlDatabaseEngine { get; set; }
        public string projectUrlDatabaseName { get; set; }
        public string projectUrlDatabaseHostname { get; set; }
        public string projectUrlDatabasePort { get; set; }

        public ProjectEPSWithURLView()
        { }
    }
}