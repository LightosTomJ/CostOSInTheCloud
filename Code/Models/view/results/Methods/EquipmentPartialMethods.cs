...
{
    [Serializable]
    public class EquipmentPartialResult //: IPartialResult
	{
		...
		//private IList<Equipment> partialResult;
		...
		//public EquipmentPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<Equipment> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<Equipment> PartialResult
		//{
		//	get
		//	{
