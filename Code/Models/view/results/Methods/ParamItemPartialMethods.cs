...
namespace Models.results.Methods
{
	[Serializable]
	public class ParamItemPartialResult //: IPartialResult
	{
		...
		//private IList<ParamItem> partialResult;

		//public ParamItemPartialResult()
		//{
		//   // We need this constructor to initialize the webservice	
		//}

		//public ParamItemPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<ParamItem> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual int? PartialSize
		//{
		//	get
		//	{
		//		return partialSize;
		...
		//	set
		//	{
		//		this.partialSize = value;
		//	}
		//}
		//public virtual int? PartialStart
		//{
		//	get
		//	{
		//		return partialStart;
		...
		//	}
		//}
		//public virtual IList<ParamItem> PartialResult
		//{
		//	get
		//	{
		...
		//public virtual System.Collections.IList Result
		//{
		//	get
		//	{
		//		return partialResult;
