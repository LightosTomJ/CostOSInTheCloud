...
{
    [Serializable]
    public class MaterialPartialResult //: IPartialResult
	{
		...
		//private IList<Material> partialResult;
		...
		//public MaterialPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<Material> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<Material> PartialResult
		//{
		//	get
		//	{
