...
{
    [Serializable]
    public class ConsumablePartialResult //: IPartialResult
    {
        ...
        //private IList<Consumable> partialResult;
        ...
        //public ConsumablePartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<Consumable> partialResult) : base()
        //{
        ...
        //	}
        //}
        //public virtual IList<Consumable> PartialResult
        //{
        //	get
        //	{
