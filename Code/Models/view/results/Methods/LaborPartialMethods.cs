...
{
    [Serializable]
    public class LaborPartialResult //: IPartialResult
	{
		...
		//private IList<Labor> partialResult;
		...
		//public LaborPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<Labor> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<Labor> PartialResult
		//{
		//	get
		//	{
