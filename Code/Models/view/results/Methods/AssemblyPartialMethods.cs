...
{
    [Serializable]
    public class AssemblyPartialResult //: IPartialResult
	{
		...
		//private IList<Assembly> partialResult;
		...
		//public AssemblyPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<Assembly> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<Assembly> PartialResult
		//{
		//	get
		//	{
