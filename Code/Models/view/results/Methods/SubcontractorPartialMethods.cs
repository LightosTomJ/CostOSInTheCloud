...
{
    [Serializable]
    public class SubcontractorPartialResult //: IPartialResult
	{
		...
		//private IList<Subcontractor> partialResult;
		...
		//public SubcontractorPartialResult(int? resultSize, int? partialSize, int? partialStart, string sortByField, bool asceding, string query, string queryType, double seconds, int? pageSize, IList<Subcontractor> partialResult) : base()
		//{
		...
		//	}
		//}
		//public virtual IList<Subcontractor> PartialResult
		//{
		//	get
		//	{
