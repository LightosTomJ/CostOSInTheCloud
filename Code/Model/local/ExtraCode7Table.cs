...
namespace Model.local
{
	...
	/// 
	/// @hibernate.class table="EXTRACODE7"
	/// @hibernate.cache usage="nonstrict-read-write"
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Indexed public class ExtraCode7Table implements nomitech.common.base.GroupCode, java.awt.datatransfer.Transferable, java.io.Serializable, nomitech.common.base.BaseTable
	[Serializable]
	public class ExtraCode7Table : GroupCode, Transferable, BaseTable
	{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DocumentId private System.Nullable<long> extraCode7Id = null;
		private long? extraCode7Id = null;
		private string extraCode7 = null;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) private java.math.BigDecimal unitFactor = null;
		...
		private static readonly DataFlavor[] s_supportedDataFlavors = new DataFlavor[] {DataFlavors.extraCode7DataFlavor};
	...
	//		if ( !(val instanceof ExtraCode7Table) ) {
	//			return false;
	//		}
	//		final String lastUpdate = "lastUpdate";
	//		ExtraCode7Table group = (ExtraCode7Table)val;
	...
	//	}
		...
		{
			ExtraCode7Table obj = new ExtraCode7Table();

			obj.ExtraCode7Id = ExtraCode7Id;
		...
		public virtual ExtraCode7Table Data
		{
			set
			{
		...
		public virtual void setFieldData(string field, ExtraCode7Table data)
		{
		...
		public virtual long? ExtraCode7Id
		{
			get
			{
				return extraCode7Id;
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.YES) public String getGroupCode()
		...
		{
			return DataFlavors.extraCode7DataFlavor.Equals(flavor);
		}
...
//ORIGINAL LINE: public synchronized Object getTransferData(java.awt.datatransfer.DataFlavor flavor) throws java.awt.datatransfer.UnsupportedFlavorException, java.io.IOException
		public virtual object getTransferData(DataFlavor flavor)
		{
			lock (this)
			{
				if (DataFlavors.extraCode7DataFlavor.Equals(flavor))
				{
					return this;
				}
		...
		{
			return extraCode7.CompareTo(o.GroupCode);
		}
		/////////////////////////////////////////////////////
		// SORTING FIELDS                                  //
		/////////////////////////////////////////////////////
...
//ORIGINAL LINE: @Field(store = org.hibernate.search.annotations.Store.NO) public java.util.Date getLastUpdate_sorted()
		...
		public override GroupCode Data
		{
			set
			{
				Data = (ExtraCode7Table)value;
			}
		}

		public override void setFieldData(string field, GroupCode groupCodeTable)
		{
			setFieldData(field,(ExtraCode7Table)groupCodeTable);
		}
