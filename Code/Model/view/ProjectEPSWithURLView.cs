...
namespace Model.view
{
	...
	[Serializable]
	public class ProjectEPSWithURLView
	{
		...
		private string projectUrlRevisionName;
		private string projectUrlType;
		private bool? projectUrlIsDefaultRevision;
		private string projectUrlEditorId;

		private DateTime projectUrlLastUpdate;
		private string projectUrlDatabaseEngine;
		private string projectUrlDatabaseName;
		private string projectUrlDatabaseHostname;
		private string projectUrlDatabasePort;
		...
		public virtual string ProjectUrlName
		{
			get
			{
			...
			set
			{
				this.projectUrlName = value;
			}
		}
		public virtual string ProjectUrlRevisionName
		{
			get
			{
				return projectUrlRevisionName;
			}
			set
			{
				this.projectUrlRevisionName = value;
			}
		}
		public virtual string ProjectUrlType
		{
			get
			{
			...
			set
			{
				this.projectUrlType = value;
			}
		}
		public virtual bool? ProjectUrlIsDefaultRevision
		{
			get
			{
				return projectUrlIsDefaultRevision;
			}
			set
			{
				this.projectUrlIsDefaultRevision = value;
			}
		}
		public virtual string ProjectUrlEditorId
		{
			get
			{
				return projectUrlEditorId;
			}
			set
			{
				this.projectUrlEditorId = value;
			}
		}
		public virtual DateTime ProjectUrlLastUpdate
		{
			get
			{
				return projectUrlLastUpdate;
			}
			set
			{
				this.projectUrlLastUpdate = value;
			}
		}
		public virtual string ProjectUrlDatabaseEngine
		{
			get
			{
				return projectUrlDatabaseEngine;
			}
			set
			{
				this.projectUrlDatabaseEngine = value;
			}
		}
		public virtual string ProjectUrlDatabaseName
		{
			get
			{
				return projectUrlDatabaseName;
			}
			set
			{
				this.projectUrlDatabaseName = value;
			}
		}
		public virtual string ProjectUrlDatabaseHostname
		{
			get
			{
				return projectUrlDatabaseHostname;
			}
			set
			{
				this.projectUrlDatabaseHostname = value;
			}
		}
		public virtual string ProjectUrlDatabasePort
		{
			get
			{
				return projectUrlDatabasePort;
			}
			set
			{
				this.projectUrlDatabasePort = value;
			}
		}
