...
DECLARE my_Cursor CURSOR LOCAL FAST_FORWARD FOR ( SELECT NAME,DISPLAYNAME,FIELDNAME,COLUMNNAME  FROM FIELDCUSTOM INNER JOIN CostOS.dbo.BOQITEMMETADATA on FIELDCUSTOM.NAME = CostOS.dbo.BOQITEMMETADATA.FIELDKEY WHERE FIELDCUSTOM.DISPLAYNAME IS NOT NULL ) ;
OPEN my_Cursor ;
